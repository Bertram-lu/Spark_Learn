...
import com.atguigu.spark.project.bean.{HotCategory, UserVisitAction}
import com.atguigu.spark.project.common.TService
import com.atguigu.spark.project.dao.HotCategorySessionAnalysisTop10Dao
...
class HotCategorySessionAnalysisTop10Service extends TService {
    ...
    def analysis1(categories:List[HotCategory]) = {
        ...
        val fileRDD =
            hotCategorySessionAnalysisTop10Dao.readFile("Spark/input/user_visit_action.txt")
